  ...
  return (
    <div className="dp-mesh min-h-screen text-zinc-900">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        <h1 className="dp-display text-3xl font-bold text-zinc-900">Privacy Policy</h1>
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-zinc-400">
          <section>
            <h2 className="text-lg font-bold text-zinc-900">1. Who we are</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">2. Data we collect</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">3. How we use data</h2>
            <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">4. Processors</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">5. Emails</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">6. Retention</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">7. Your choices</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">8. Security</h2>
            <p className="mt-2">
