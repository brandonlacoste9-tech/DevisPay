...
export default function TermsPage() {
  return (
    <div className="dp-mesh min-h-screen text-zinc-900">
      <header className="border-b border-zinc-900/10 px-4 py-5">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 prose-invert">
        <h1 className="dp-display text-3xl font-bold text-zinc-900">Terms of Service</h1>
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-zinc-400">
          <section>
            <h2 className="text-lg font-bold text-zinc-900">1. Service</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">2. Not legal escrow or trust accounts</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">3. Accounts</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">4. Payments between you and your clients</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">5. Our subscription fees</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">6. Acceptable use</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">7. Data & availability</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">8. Disclaimer & liability</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-zinc-900">9. Contact</h2>
            <p className="mt-2">
